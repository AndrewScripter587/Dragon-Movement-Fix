...
execute as @e[type=ender_dragon] unless data entity @s {DragonPhase:5} unless data entity @s {DragonPhase:6} unless data entity @s {DragonPhase:7} if score @s YVel matches 1500.. run scoreboard players set @s YVel 1500
execute as @e[type=ender_dragon] unless data entity @s {DragonPhase:5} unless data entity @s {DragonPhase:6} unless data entity @s {DragonPhase:7} if score @s YVel matches ..-1500 run scoreboard players set @s YVel -1500
